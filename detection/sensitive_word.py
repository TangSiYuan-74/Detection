...
SENSITIVE_WORDS_DATA_PATH = "C:/Users/basketfatty/Desktop/tencent-sensitive-words-main/words/"
...
class SensitiveWords(object):
    ...
    def save_data(self):
        ...
        for word_type in self.sensitive_word_dict.keys():
            # file_path = list(filter(lambda x: word_type in x, self.file_path_list))[0]
