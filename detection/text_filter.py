...
if __name__ == '__main__':
    ...
    print(t.filter(u'法论功大发好,真善忍好', replace_char=u'-'))  # 敏感词过滤,指定替换字符

    print(t.filter('高效低价英雄联盟代练'))  # 测试添加敏感词功能
    t.add_word(u'英雄联盟代练')
    print(t.filter('高效低价英雄联盟代练'))

    d = t.classifie('出售幼,女私房照,小萝,莉私房,联系QQxxx')
    print(t.filter('出售幼,女私房照,小萝,莉私房,联系QQxxx'))